...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--backbone",
        choices=["vgg16", "resnet18", "resnet50", "inception_v3"],
        default="resnet18",
    ...
    parser.add_argument("--image-size", type=int, default=None, help="Optional square input size override.")
    ...
    parser.add_argument("--precision", default="16-mixed", help="Lightning numerical precision.")
    parser.add_argument(
        "--no-pretrained",
        action="store_true",
...
def main() -> None:
    ...
    if args.accelerator in {"auto", "gpu", "cuda"}:
        import torch
